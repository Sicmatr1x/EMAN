			...
			<div class="col-md-12 column">
				<nav class="navbar navbar-default" role="navigation">
					<div class="navbar-header">
						<a class="navbar-brand" href="http://localhost:8080/EMAN"><span
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav navbar-right" id="user-nav">
							...
							if(state != null && state.equals("login")){
								out.print("<a href=\"http://localhost:8080/EMAN/user/home.htm\">" + uname + "</a>");

								out.println("<a href=\"http://localhost:8080/EMAN/user/logout.htm\">" + "注销" + "</a>");
							}else{
